...
import com.learning.interrogation.domain.constant.RedisConstant;
...
import com.learning.interrogation.domain.po.patient.*;
...
import com.learning.interrogation.server.util.*;
...
public class InformationPatientServiceImpl
        extends ServiceImpl<InformationPatientMapper, InformationPatientPo>
    ...
    private final IVisitCardAssociationService visitCardAssociationService;
    ...
    public Map<String, Object> addPatient(PatientAddVO patient) {
        ...
        String cjzrbm = ObjectUtil.isNotEmpty(patient.getCJZRBM()) ? patient.getCJZRBM() : snowflakeIdUtil.getSnowflakeId();
        ...
        if ("0".equals(patient.getCGXBM())) {
            ...
            wlylYhjzrxxgl.setCBM(snowflakeIdUtil.getSnowflakeId());
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Map<String, Object> liteFlowAddPatient(PatientAddVO patient) {
        ...
        throw new RuntimeException("新增就诊人失败");
    }
    ...
    public List<PatientUserDTO> getPatientInfo(String idCardType, String idCard, String userId) {
        ...
        List<PatientUserDTO> patientUserDtos = this.baseMapper.listPatientWithUserId(
                Wrappers.<InformationPatientPo>query()
                        ...
                        .lambda()
                        .eq(InformationPatientPo::getCZJLX, idCardType)
                        .eq(InformationPatientPo::getCJZRSFZH, idCard)
        );
    ...
    private PatientUserDTO saveOneself(String jzrBm, PatientAddVO patientVo, PatientUserDTO patientData) {
        ...
        authRecord.setCBM(snowflakeIdUtil.getSnowflakeId()).setCJZRBM(jzrBm)
