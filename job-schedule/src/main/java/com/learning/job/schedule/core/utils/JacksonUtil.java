...
public class JacksonUtil {
    ...
    public static String writeValueAsString(Object obj) {
        try {
            ...
            JsonGenerationException e = var2;
            logger.error(e.getMessage(), e);
        } catch (JsonMappingException var3) {
            JsonMappingException e = var3;
            logger.error(e.getMessage(), e);
    ...
    public static <T> T readValue(String jsonStr, Class<T> clazz) {
        try {
            ...
            JsonParseException e = var3;
            logger.error(e.getMessage(), e);
        } catch (JsonMappingException var4) {
            JsonMappingException e = var4;
            logger.error(e.getMessage(), e);
    ...
    public static <T> T readValue(String jsonStr, Class<?> parametrized, Class<?>... parameterClasses) {
        try {
            ...
            JsonParseException e = var4;
            logger.error(e.getMessage(), e);
        } catch (JsonMappingException var5) {
            JsonMappingException e = var5;
            logger.error(e.getMessage(), e);
