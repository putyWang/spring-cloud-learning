...
import com.learning.conditions.query.QueryWrapper;
...
public interface IRepository<T, ID extends Serializable> {
     ...
     * 根据 entity 条件，删除记录
     *
     * @param queryWrapper 实体包装类 {@link com.learning.conditions.query.QueryWrapper}
     */
     ...
     *
     * @param updateWrapper 实体对象封装操作类 {@link com.learning.conditions.update.UpdateWrapper}
     */
     ...
     * 根据 Wrapper，查询一条记录
     *
     * @param queryWrapper 实体对象封装操作类 {@link com.learning.conditions.query.QueryWrapper}
